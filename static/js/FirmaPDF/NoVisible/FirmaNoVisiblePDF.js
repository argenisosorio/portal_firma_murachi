...
| servidor de Murachí, valida que se haya cargado
...
function SubirDocumentServerNoVisible(formData){
  $.ajax({
    ...
    error: function(response) {
      // Si hubo un error subiendo el archivo al servidor mostrara este mensaje en un div de la plantilla
      $("#respuesta_NoVisible").html('Error, no se ha subido el archivo al servidor');
