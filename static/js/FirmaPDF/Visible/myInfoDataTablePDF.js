...
function InfoContent(id){
  ...
  for (var i = 0; i < INFO_DATATABLE.signatures.length; i++) {
    if (parseInt(INFO_DATATABLE.signatures[i]['documentRevision']) == parseInt(id)){
            ...
            html1 += '<td style="text-align: left" width="500"><span> '+INFO_DATATABLE.signatures[i]['nameOfTheSigner']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Fecha en que se realiza la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['signedOn']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Chequea la integridad de la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['integrityCheck']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>El certificado todavía está válido:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['signerCertificateStillValid']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Fecha de fin de validez del certificado:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['signerCertificateValidFrom']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Fecha de fin de validez del certificado:</b> </td>';
            html1 += '<td style="text-align: left"><span>' +INFO_DATATABLE.signatures[i]['signerCertificateValidTo']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>El certificado es válido en el momento de la firma:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE.signatures[i]['signerCertificateValidAtTimeOfSigning']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Tipo de firma de archivo PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['signatureType']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Estampilla de tiempo:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['timeStamp']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Razón de la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['reason']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Ubicación donde se realiza la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['location']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Nombre alternativo del firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['alternativeNameOfTheSigner']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>La firma abarca todo el documento PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span>' +INFO_DATATABLE.signatures[i]['signatureCoversWholeDocument']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Tipo de subfiltro: /adbe.pkcs7.sha1, /adbe.pkcs7.detached:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE.signatures[i]['filterSubtype']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Sujeto firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span><font style="font-size: 8pt">' +INFO_DATATABLE.signatures[i]['signerCertificateSubject']+'</font></span></td>';
            html1 += '</tr>';
            html1 += '<td style="text-align: left" ><b>Algoritmo de cifrado:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE.signatures[i]['encryptionAlgorithm']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Servicio de estampillado de tiempo:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['timeStampService']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Algoritmo hash (reseña):</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['digestAlgorithm']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Certificado verificado contra el repositorio de certificados confiables:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['certificatesVerifiedAgainstTheKeyStore']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Número de revisión del documento PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['documentRevision']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Número total de revisiones del documento PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE.signatures[i]['totalDocumentRevisions']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Información de contacto del firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span>' +INFO_DATATABLE.signatures[i]['contactInfo']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Estampilla de tiempo verificada:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE.signatures[i]['timeStampVerified']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Emisor del certificado firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span><font style="font-size: 8pt">' +INFO_DATATABLE.signatures[i]['signerCertificateIssuer']+'</font></span></td>';
            html1 += '</tr>';;
            html1 += '</table>';
            html1 += '</font>';

            $('div#Dialogo-table').append(html1); 
    }
  }
}
...
function DataTablePDF(response){
  
    //$(document).ready(function () { 
    	var table = $('#myJson').DataTable({
          //retrieve: true,
          //paging: false,
          //searching: false,                            
           language: {
           ...
           columns: [
              ...
              {title:"Información", data: function(event){
                                              return '<button id="informacion" type="input" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" onclick="javascript:Dialog('+event.documentRevision+')">Info(<font color="red">'+event.documentRevision+'</font>)</button>';
                                         } 
              }
           ],                           
          dom: 'Bfrtip',
