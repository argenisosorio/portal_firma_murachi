...
function InfoContentMultiples(id){
  
  for (var i = 0; i < INFO_DATATABLE_MULTIPLES.signatures.length; i++) {
    if (parseInt(INFO_DATATABLE_MULTIPLES.signatures[i]['documentRevision']) == parseInt(id)){
            ...
            html1 += '<td style="text-align: left" width="500"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['nameOfTheSigner']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Fecha en que se realiza la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['signedOn']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Chequea la integridad de la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['integrityCheck']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>El certificado todavía está válido:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['signerCertificateStillValid']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Fecha de fin de validez del certificado:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['signerCertificateValidFrom']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Fecha de fin de validez del certificado:</b> </td>';
            html1 += '<td style="text-align: left"><span>' +INFO_DATATABLE_MULTIPLES.signatures[i]['signerCertificateValidTo']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>El certificado es válido en el momento de la firma:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['signerCertificateValidAtTimeOfSigning']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Tipo de firma de archivo PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['signatureType']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Estampilla de tiempo:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['timeStamp']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Razón de la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['reason']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Ubicación donde se realiza la firma:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['location']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Nombre alternativo del firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['alternativeNameOfTheSigner']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>La firma abarca todo el documento PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span>' +INFO_DATATABLE_MULTIPLES.signatures[i]['signatureCoversWholeDocument']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Tipo de subfiltro: /adbe.pkcs7.sha1, /adbe.pkcs7.detached:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['filterSubtype']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Sujeto firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span><font style="font-size: 8pt">' +INFO_DATATABLE_MULTIPLES.signatures[i]['signerCertificateSubject']+'</font></span></td>';
            html1 += '</tr>';
            html1 += '<td style="text-align: left" ><b>Algoritmo de cifrado:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['encryptionAlgorithm']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Servicio de estampillado de tiempo:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['timeStampService']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Algoritmo hash (reseña):</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['digestAlgorithm']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Certificado verificado contra el repositorio de certificados confiables:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['certificatesVerifiedAgainstTheKeyStore']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Número de revisión del documento PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['documentRevision']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Número total de revisiones del documento PDF:</b> </td>';
            html1 += '<td style="text-align: left"><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['totalDocumentRevisions']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Información de contacto del firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span>' +INFO_DATATABLE_MULTIPLES.signatures[i]['contactInfo']+'</span></td>';
            html1 += '</tr>'; 
            html1 += '<tr>';
            html1 += '<td style="text-align: left" ><b>Estampilla de tiempo verificada:</b> </td>';
            html1 += '<td style="text-align: left" ><span> '+INFO_DATATABLE_MULTIPLES.signatures[i]['timeStampVerified']+'</span></td>';
            html1 += '</tr>';
            html1 += '<tr>';
            html1 += '<td style="text-align: left"><b>Emisor del certificado firmante:</b> </td>';
            html1 += '<td style="text-align: left"><span><font style="font-size: 8pt">' +INFO_DATATABLE_MULTIPLES.signatures[i]['signerCertificateIssuer']+'</font></span></td>';
            html1 += '</tr>';;
            html1 += '</table>';
            html1 += '</font>';

            $('div#Dialogo-table-Multiples').append(html1); 
    }
  }
}
       ...
       <div class="modal-dialog">\
         <div class="modal-content">\
           ...
           <div id = "body" class="modal-body">\
             <br>\
             <div id="Dialogo-table-Multiples"></div>\
            </div>\
...
function DataTablePDFMultiples(response){
    ...
    //$(document).ready(function () { 
    	var table = $('#myJsonPDFMultiples').DataTable({
          //retrieve: true,
          //paging: false,
          //searching: false,                            
           language: {
           ...
           columns: [
              ...
              {title:"Información", data: function(event){
                                              return '<button id="informacion" type="input" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" onclick="javascript:DialogMultiples('+event.documentRevision+')">Info(<font color="red">'+event.documentRevision+'</font>)</button>';
                                         } 
              }
           ],                           
          dom: 'Bfrtip',
          columnDefs: [
           ...
           buttons: [
                ...
                },
                {
                    extend:    'print',
                    text:      'Imprimir',
                    title:     'Contenido de la Firma Multiples',
